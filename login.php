...
<body>
    ...
    <a href="landing.php" class="back-link" style="position: absolute; top: 30px; left: 40px;">
    ...
    <div class="login-container">
        ...
        <div class="brand-section">
            ...
            <p class="brand-subtitle">Silakan masuk menggunakan username dan password Anda untuk mengakses sistem SIMKAB.</p>
        </div>
